...
const STAGE_MESSAGES = {
    ...
    experiment3: 'Финальная проверка. Это может быть новая гипотеза, продолжение прошлой или проверка устойчивости результата.',
...
export async function renderHome(root) {
    ...
    <div class="home-card">
      ...
      ${!over
        ? `<button class="btn btn--primary btn--block" id="home-cta">${todayFilled ? 'Изменить сегодняшний день' : 'Записать сегодняшний день'}</button>`
...
function renderProgressDots(currentDay, filled) {
    let html = '';
