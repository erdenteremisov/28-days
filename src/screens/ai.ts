  ...
  const options: PromptOption[] = [
    ...
    },
    {
      ...
      build: (allDays, exps, m) =>
        buildWeek2Prompt(m, allDays.filter((d) => d.dayNumber <= 14), exps.find((e) => e.number === 1)),
    },
    {
      id: 'week3',
      ...
      build: (allDays, exps, m) =>
        buildWeek3Prompt(
          m,
          allDays.filter((d) => d.dayNumber <= 21),
    ...
    },
    {
      ...
      minDay: 28,
      build: (allDays, exps, m) =>
        buildFinalPrompt(m, allDays, exps.find((e) => e.number === 1), exps.find((e) => e.number === 2)),
    },
  ];
